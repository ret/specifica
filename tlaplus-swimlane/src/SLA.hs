                              ...
                              Just g@(VA_FunctionDef _ _ _ _) ->
                                let slafun = wrapSLAFun env g
                                 in case Map.lookup 
                                           ...
                                           m of
                                      Just f@(VA_FunctionDef _info head
                                                qbounds expr) ->
...
wrapStateFun globalenv f@(VA_FunctionDef _info head qbounds expr) =
...
wrapSLAFun globalenv f@(VA_FunctionDef _info head qbounds expr) =
    -- FIXME must enforce qbounds!
    \statelist ->
